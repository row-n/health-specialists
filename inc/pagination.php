...
<div class="pagination pagination--archive">
	...
	<div class="pagination__prev"><?php next_posts_link(__('&larr; Previous', 'healthspecialists')); ?></div>

	<?php endif; ?>

	<?php if (get_previous_posts_link()) : ?>

	<div class="pagination__next"><?php previous_posts_link(__('Next &rarr;', 'healthspecialists')); ?></div>
